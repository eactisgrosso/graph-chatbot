...
export const GraphIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      strokeLinejoin="round"
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M8 1.5C6.5 1.5 5.2 2.1 4.3 3.1C3.8 2.8 3.2 2.6 2.5 2.6C1.1 2.6 0 3.7 0 5.1C0 6.5 1.1 7.6 2.5 7.6C2.8 7.6 3.1 7.5 3.3 7.4C3.2 7.8 3.1 8.2 3.1 8.6C3.1 11.2 5.2 13.3 7.8 13.3C8.2 13.3 8.6 13.2 9 13.1C9.4 13.2 9.8 13.3 10.2 13.3C12.8 13.3 14.9 11.2 14.9 8.6C14.9 8.2 14.8 7.8 14.7 7.4C14.9 7.5 15.2 7.6 15.5 7.6C16.9 7.6 18 6.5 18 5.1C18 3.7 16.9 2.6 15.5 2.6C14.8 2.6 14.2 2.8 13.7 3.1C12.8 2.1 11.5 1.5 10 1.5H8ZM8 3C9.1 3 10.1 3.4 10.8 4.1C11.1 4.3 11.5 4.4 11.9 4.4C12.7 4.4 13.4 4.9 13.6 5.6C13.7 6 13.6 6.4 13.4 6.7C13.1 7.1 12.9 7.5 12.9 8C12.9 9.7 11.6 11 9.9 11C9.5 11 9.1 10.9 8.8 10.7C8.4 10.9 8 11 7.6 11C5.9 11 4.6 9.7 4.6 8C4.6 7.5 4.4 7.1 4.1 6.7C3.9 6.4 3.8 6 3.9 5.6C4.1 4.9 4.8 4.4 5.6 4.4C6 4.4 6.4 4.3 6.7 4.1C7.4 3.4 8.4 3 9.5 3H8Z"
        fill="currentColor"
      />
    </svg>
  );
